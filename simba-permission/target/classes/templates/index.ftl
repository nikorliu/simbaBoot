					...
					<div class="navbar-custom-menu">
									...
									<li>
										...
										<ul class="menu">
											<li>
												...
												<a href="#">
													<div class="pull-left">
														<img src="${base}/img/user2-160x160.jpg" class="img-circle" alt="User Image">
													</div>
													<h4>
                        Support Team
                        <small><i class="fa fa-clock-o"></i> 5 mins</small>
											...
											<li>
												<a href="#">
													<div class="pull-left">
														<img src="${base}/img/user3-128x128.jpg" class="img-circle" alt="User Image">
													</div>
													<h4>
                        ...
                        <small><i class="fa fa-clock-o"></i> 2 hours</small>
											...
											<li>
												<a href="#">
													<div class="pull-left">
														<img src="${base}/img/user4-128x128.jpg" class="img-circle" alt="User Image">
													</div>
													<h4>
                        Developers
