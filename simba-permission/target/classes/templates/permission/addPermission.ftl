					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return Permission.checkForm();" id="form" action="${base}/permission/add">
									<div class="box-body">
										<div class="form-group">
											<label for="text">名称</label>
											<input type="text" class="form-control" id="text" name="text" placeholder="请输入名称">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="url" name="url" placeholder="请输入URL,多个URL使用英文逗号隔开">
										</div>
									</div>
									<!-- /.box-body -->
