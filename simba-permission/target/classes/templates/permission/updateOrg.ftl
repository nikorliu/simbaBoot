					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return Org.checkForm();" id="form" action="${base}/org/update">
									<input type="hidden" id="id" name="id" value="${org.id}" />
									<div class="box-body">
										<div class="form-group">
											<label for="text">名称</label>
											<input type="text" class="form-control" id="text" name="text" placeholder="请输入机构名称" value="${org.text}">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="orderNo" name="orderNo" placeholder="请输入排序值" value="${org.orderNo}">
										</div>
									</div>
									<!-- /.box-body -->
