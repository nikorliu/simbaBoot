						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增${classDesc}</h3>
								</div>
								<form role="form" onsubmit="return ${className}.checkForm();" id="form" action="${dollar}{base}/${firstLower}/add">
									<div class="box-body">
										<#list filedsWithPage as field> 
										<div class="form-group">
											<label for="${field.key}">${field.desc}</label>
											<input type="text" class="form-control" id="${field.key}" name="${field.key}" placeholder="请输入${field.desc}">
										</div>
										</#list> 
										<div class="form-group">
