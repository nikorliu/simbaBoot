					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return Buss.checkForm();" id="form" action="${base}/buss/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<textarea class="form-control" rows="20" placeholder="请输入脚本" id="script" name="script"></textarea>
										</div>
										<div class="form-group">
