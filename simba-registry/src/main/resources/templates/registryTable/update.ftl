						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">修改注册类型表</h3>
								</div>
								<form role="form" onsubmit="return RegistryTable.checkForm();" id="form" action="${base}/registryTable/update">
									<input type="hidden" id="id" name="id" value="${registryTable.id}" />
									<div class="box-body">
										<div class="form-group">
											<label for="code">编码</label>
											<input type="text" class="form-control" id="code" name="code" placeholder="请输入编码" value="${registryTable.code}">
										</div>
										<div class="form-group">
											<label for="value">值</label>
											<input type="text" class="form-control" id="value" name="value" placeholder="请输入值" value="${registryTable.value}">
										</div>
										<div class="form-group">
											<label for="description">描述</label>
											<input type="text" class="form-control" id="description" name="description" placeholder="请输入描述" value="${registryTable.description}">
										</div>
										<div class="form-group">
											<label for="typeName">注册类型</label>
											<input type="hidden" id="typeID" name="typeID" value="${registryTable.typeID}" />
